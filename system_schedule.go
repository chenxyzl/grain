...
// ScheduleOnce delivers msg to target after delay.
//
// msg is delivered as-is and is shared with the caller until then — see IScheduler for
// why that matters and what to do instead.
...
// ScheduleRepeated delivers msg to target after delay, then every interval until the
// returned func is called.
//
// ⚠️ Every tick delivers the SAME msg instance, aliased with the caller and with the
